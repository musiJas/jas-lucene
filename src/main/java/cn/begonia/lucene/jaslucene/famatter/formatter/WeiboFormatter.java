...
/*   Field.Index.ANALYZED:分词建索引
    ...
    WeiboFormatter(String field, Class fieldType, Field.Store  storeValue, Field.Index indexValue, Float  boost){
        this.field=field;
    ...
    public static  String[]  listFields(){
        ...
        for(WeiboFormatter matter: WeiboFormatter.values()){
    ...
    public static JSONObject  resolveDocument(Document  document){
         ...
         for(WeiboFormatter formatter: WeiboFormatter.values()){
             // 对date做格式转换
    ...
    public  static Sort   getDefaultSort(){
        SortField  like=new SortField("focus",SortField.Type.INT,true);
    ...
    public static Field initialFormatter(String field, String value){
        for(WeiboFormatter bf: WeiboFormatter.values()){
