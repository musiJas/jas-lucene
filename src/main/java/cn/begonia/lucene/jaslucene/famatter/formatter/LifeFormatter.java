...
public enum LifeFormatter {
    ...
    releaseDate("releaseDate",StringField.class,Field.Store.YES, Field.Index.NOT_ANALYZED,1.0f),
    ...
    LifeFormatter(String field, Class fieldType, Field.Store  storeValue, Field.Index indexValue, Float  boost){
        this.field=field;
    ...
    public static  String[]  listFields(){
        ...
        for(LifeFormatter matter: LifeFormatter.values()){
    ...
    public static Field initialFormatter(String field, String value){
        ...
        for(LifeFormatter bf: LifeFormatter.values()){
