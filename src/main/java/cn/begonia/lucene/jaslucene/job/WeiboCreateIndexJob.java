...
public class WeiboCreateIndexJob {
    ...
    public  void  executeJob(){
        log.info("开始创建索引数据.{}"+CacheType.weibo.getKey());
        RedisSource redisSource=new RedisSource();
        redisSource.setCategory(CacheType.weibo.getKey());
        redisSource.setIndexPath(contextProperties.getIndexPath()+ File.separator+CacheType.weibo.getKey());
